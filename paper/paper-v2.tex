...
C). Whether an interaction is present thus depends on the scale on which
effects are assumed to add. Additivity on the log scale implies
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, coltitle=black, colback=white, opacitybacktitle=0.6, breakable, colframe=quarto-callout-note-color-frame, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, title={Box 1: Generalized linear models: outcome family and link function}, toprule=.15mm, left=2mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm]
