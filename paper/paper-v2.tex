...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, title={Box 1: Generalized linear models: outcome family and link function}, colback=white, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, titlerule=0mm, breakable, opacityback=0, toptitle=1mm, bottomrule=.15mm]
