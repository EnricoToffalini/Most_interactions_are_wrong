...
In a simple 2 Ã— 2 design, let $\mu_{00}, \mu_{10}, \mu_{01}, \mu_{11}$ be the four expected response means generated with no product-term interaction on the target link scale. If the fitted model uses link $g$, the induced interaction on that fitted scale is
