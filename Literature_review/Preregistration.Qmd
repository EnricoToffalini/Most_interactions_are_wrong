...
|  |  |  |
| *Finds_significant_interactions* | Whether at least one interaction (where the link function was incorrectly specified as identity) yields a statistically significant result. | Boolean |
|  |  |  |
