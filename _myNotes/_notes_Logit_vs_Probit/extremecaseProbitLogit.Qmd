...
library(DHARMa)
simulation_probit = simulateResiduals(fittedModel = fitLP)
simulation_logit = simulateResiduals(fittedModel = fitLL)
testDispersion(simulation_probit)
testDispersion(simulation_logit)
# plot(simulation_probit)
# plot(simulation_logit)

# testUniformity(fitLP)
# testUniformity(fitLL)
...
library(DHARMa)
simulation_probit = simulateResiduals(fittedModel = fitPP)
simulation_logit = simulateResiduals(fittedModel = fitPL)
testDispersion(simulation_probit)
testDispersion(simulation_logit)
# plot(simulation_probit)
# plot(simulation_logit)
